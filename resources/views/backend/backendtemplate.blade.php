...
<head>
  ...
  <link href="{{ asset('backend/style/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
...
<body id="page-top">
  ...
  <script src="{{ asset('backend/style/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{ asset('backend/style/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Core plugin JavaScript-->
  <script src="{{ asset('backend/style/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{ asset('backend/style/js/sb-admin-2.min.js')}}"></script>

  <!-- Page level plugins -->
  <script src="{{ asset('backend/style/vendor/chart.js/Chart.min.js')}}"></script>
